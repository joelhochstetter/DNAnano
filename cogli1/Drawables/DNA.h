...
public:
	...
	Nucleotide(glm::vec3 pos, glm::vec3 principal, glm::vec3 stacking, glm::vec4 color);
	virtual ~Nucleotide();
...
public:
	...
	virtual void set_opacity(float n_op);
	void finalise();
	virtual glm::vec3 position() { return _com; }
	...
	virtual void shift_com_only(glm::vec3 &amount) { _com += amount; }
	virtual void rotate(glm::mat3, glm::vec3);
};
