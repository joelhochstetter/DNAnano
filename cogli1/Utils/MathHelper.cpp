...
glm::mat4 MathHelper::get_rotation(glm::vec3 initial, glm::vec3 final) {
...
void MathHelper::orthonormalize(glm::dmat4 &m) {
...
void MathHelper::eigenvalues_rotate(glm::mat3 &mat, double &c, double &s, int i0, int j0, int i1, int j1) {
...
void MathHelper::diagonalize_3x3(glm::mat3 &mat, glm::vec3 &values, glm::mat3 &vectors) {
...
glm::vec3 MathHelper::eigenvalues_jacobi(glm::mat3 &mat, glm::mat3 &E) {
	glm::vec3 ret;
	...
	Logging::log_critical("Too many iterations in MathHelper::eigenvalues_jacobi\n");
	exit(1);
