...
foreach s (0.001 0.01 0.05 0.1 0.5 1.0 5.0) 
    rm external.conf
    python3 $oxPath/NewPore/Scripts/fix_tether.py prova.top external.conf 100 $s 21.14
...
foreach s (0.001 0.01 0.05 0.1 0.5 1.0 5.0) 
    ...
    python3 $oxPath/NewPore/Scripts/generate_cylinder.py 0 10.57 100 1 force_file.conf 61.05
